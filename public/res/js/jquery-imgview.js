...
(function ($) {
	...
	function funclass(opts, obj){
		if(!opts)opts={};
		var me = this;
		this.ismobile = winWb()<450;
		this.downbool = true;
		this.dushu	  = 0;
		this.iconpath = 'icon'; //glyphicon glyphicon
		this.init=function(){
		...
		this.showview=function(){
			var s='<div id="imgview_main" style="position:absolute;left:0px;top:0px;width:100%;height:100%;z-index:2000">';
			...
			s+='<span onclick="$(this).parent().remove()" style="position:fixed;z-index:2;top:2px;right:5px;color:white"><i class="'+this.iconpath+'-remove"></i></span>';
			...
			s+='</div>';
			s+='<div style="position:fixed;z-index:2;left:0px;bottom:0px;text-align:center;color:white;width:100%;font-size:20px;background-color:rgba(0,0,0,0.2);height:40px;line-height:40px;overflow:hidden"><i style="cursor:pointer" id="imgview_zoom-out" class="'+this.iconpath+'-zoom-out" title="缩小"></i> &nbsp; <span id="imgview_nowbili" style="font-size:14px">100%</span> &nbsp; <i style="cursor:pointer" class="'+this.iconpath+'-zoom-in" title="放大" id="imgview_zoom-in"></i>';
			s+='  &nbsp; <i style="cursor:pointer" class="'+this.iconpath+'-move" title="原始大小" id="imgview_zoom-move"></i>';
			if(this.downbool)s+='  &nbsp; <a target="_blank" download="" style="color:white" href="'+this.url+'"><i style="cursor:pointer" class="'+this.iconpath+'-download-alt" title="下载"></i></a>';
			s+='  &nbsp; <i style="cursor:pointer" class="'+this.iconpath+'-refresh" title="旋转90度" id="imgview_zoom-refresh"></i>';
			s+='</div>';
			s+='</div>';
			$('body').append(s);
